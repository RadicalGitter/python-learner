                ...
                <>
                  ...
                  <div className="task-body output-explainer">
                    ...
                    <div className={lessonComplete ? 'lesson-finished' : 'lesson-finished incomplete'}>
                      ...
                      <p>{lessonComplete ? 'You used the edit → run → observe loop that we’ll build on throughout the course.' : 'Use the numbered task line to return when you are ready to complete the practical steps.'}</p>
                    </div>
                  </div>
                </>
              )}
